Rails.application.routes.draw do
  ...
  devise_scope :user do
    ...
    get 'signup/normal_user', to: 'users/registrations#new_normal_user', as: 'new_normal_user_registration'
    post 'signup/normal_user', to: 'users/registrations#create_normal_user'
  end
